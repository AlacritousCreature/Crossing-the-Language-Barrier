...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text = "Sign Language To Text Prediction", font = ("Courier", 30, "bold"))
        ...
        self.T1.config(text = "Hand's symbol :", font = ("Courier", 30, "bold"))
        ...
        self.T3.config(text = "Sentence Developed :",font = ("Courier", 30, "bold"))
